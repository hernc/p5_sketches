...
(function(root, factory) {
  ...
  sndcore = function() {
    ...
    */
    (function(global, exports, perf) {
      ...
      if (window.hasOwnProperty('webkitAudioContext') && !window.hasOwnProperty(
          'AudioContext')) {
        ...
        if (!AudioContext.prototype.hasOwnProperty(
            'createScriptProcessor'))
          AudioContext.prototype.createScriptProcessor = AudioContext.prototype
          .createJavaScriptNode;
        if (!AudioContext.prototype.hasOwnProperty('createPeriodicWave'))
          AudioContext.prototype.createPeriodicWave = AudioContext.prototype
          .createWaveTable;
        AudioContext.prototype.internal_createGain = AudioContext.prototype
          .createGain;
        ...
        AudioContext.prototype.internal_createDelay = AudioContext.prototype
          .createDelay;
        AudioContext.prototype.createDelay = function(maxDelayTime) {
          var node = maxDelayTime ? this.internal_createDelay(
            maxDelayTime) : this.internal_createDelay();
      ...
      if (window.hasOwnProperty('webkitOfflineAudioContext') && !window
        .hasOwnProperty('OfflineAudioContext')) {
    ...
    var isOGGSupported = function() {
      return !!el.canPlayType && el.canPlayType(
    ...
    var isAACSupported = function() {
      return !!el.canPlayType && (el.canPlayType('audio/x-m4a;') || el.canPlayType(
        'audio/aac;'));
    };
  ...
  master = function() {
    ...
    p5.prototype.masterVolume = function(vol, rampTime, tFromNow) {
      if (typeof vol === 'number') {
        ...
        p5sound.output.gain.linearRampToValueAtTime(currentVol, now +
          tFromNow);
        p5sound.output.gain.linearRampToValueAtTime(vol, now + tFromNow +
          rampTime);
      } else if (vol) {
  ...
  helpers = function() {
     ...
     */
    p5.prototype._mathChain = function(o, math, thisChain, nextChain,
      type) {
  ...
  soundfile = function() {
     ...
     *  </code></div>
     */
    p5.prototype.loadSound = function(path, callback, onerror,
      whileLoading) {
      // if loading locally without a server
      if (window.location.origin.indexOf('file://') > -1 && window.cordova ===
        'undefined') {
        alert(
    ...
    p5.SoundFile.prototype.load = function(callback, errorCallback) {
      ...
      if (this.url != undefined && this.url != '') {
        ...
        request.onload = function() {
          if (request.status == 200) {
            ...
            ac.decodeAudioData(request.response, // success decoding buffer:
              ...
              function(e) {
                var err = new CustomError('decodeAudioData',
                  errorTrace, self.url);
                var msg =
            ...
            var msg = 'Unable to load ' + self.url +
              '. The request status was: ' + request.status + ' (' +
              request.statusText + ')';
            if (errorCallback) {
              err.message = msg;
              errorCallback(err);
        ...
        request.onerror = function(e) {
          var err = new CustomError('loadSound', errorTrace, self.url);
          var msg = 'There was no response from the server at ' +
            self.url + '. Check the url and internet connectivity.';
          if (errorCallback) {
            err.message = msg;
            errorCallback(err);
          } else {
     ...
     */
    p5.SoundFile.prototype.play = function(time, rate, amp, _cueStart,
      duration) {
      var self = this;
      var now = p5sound.audiocontext.currentTime;
      var cueStart, cueEnd;
      ...
      if (this.buffer) {
        ...
        if (duration) {
          ...
          duration = duration <= this.buffer.duration - cueStart ?
        ...
        this.bufferSourceNode._arrayIndex = this.bufferSourceNodes.length -
          1;
     ...
     */
    p5.SoundFile.prototype.loop = function(startTime, rate, amp,
      loopStart, duration) {
      this._looping = true;
    ...
    p5.SoundFile.prototype.setVolume = function(vol, rampTime, tFromNow) {
      if (typeof vol === 'number') {
        ...
        this.output.gain.linearRampToValueAtTime(currentVol, now +
          tFromNow);
        this.output.gain.linearRampToValueAtTime(vol, now + tFromNow +
          rampTime);
      } else if (vol) {
    ...
    p5.SoundFile.prototype.rate = function(playbackRate) {
      ...
      if (this.bufferSourceNode) {
        var now = p5sound.audiocontext.currentTime;
        this.bufferSourceNode.playbackRate.cancelScheduledValues(now);
        this.bufferSourceNode.playbackRate.linearRampToValueAtTime(Math
          .abs(rate), now);
        this._counterNode.playbackRate.cancelScheduledValues(now);
        this._counterNode.playbackRate.linearRampToValueAtTime(Math.abs(
          rate), now);
      }
    };
    // TO DO: document this
    ...
    p5.SoundFile.prototype.jump = function(cueTime, duration) {
      ...
      this.play(0, this.playbackRate, this.output.gain.value, cTime,
        eTime);
    };
    /**
    ...
    p5.SoundFile.prototype._initSourceNode = function() {
      ...
      bufferSourceNode.playbackRate.setValueAtTime(self.playbackRate,
        now);
     ...
     */
    p5.SoundFile.prototype.processPeaks = function(callback,
      _initThreshold, _minThreshold, _minPeaks) {
      ...
      var offlineContext = new OfflineAudioContext(1, bufLen,
        sampleRate);
      ...
      offlineContext.oncomplete = function(e) {
        ...
        do {
          ...
          threshold -= 0.005;
        } while (Object.keys(allPeaks).length < minPeaks && threshold >=
          minThreshold);
        // step 2:
        // find intervals for each peak in the sampleIndex, add tempos array
        var intervalCounts = countIntervalsBetweenNearbyPeaks(
          allPeaks);
        // step 3: find top tempos
        var groups = groupNeighborsByTempo(intervalCounts,
        ...
        var bpmVariance = 5;
        var tempoPeaks = getPeaksAtTopTempo(allPeaks, topTempos[0].tempo,
          filteredBuffer.sampleRate, bpmVariance);
        callback(tempoPeaks);
      };
    };
    // process peaks
    ...
    function groupNeighborsByTempo(intervalCounts, sampleRate) {
      ...
      intervalCounts.forEach(function(intervalCount, i) {
        try {
          ...
          var theoreticalTempo = Math.abs(60 / (intervalCount.interval /
            sampleRate));
    ...
    function getPeaksAtTopTempo(peaksObj, tempo, sampleRate, bpmVariance) {
      ...
      for (var i = 0; i < peaksArray.length; i++) {
        ...
        for (var j = 0; j < peak.intervals.length; j++) {
          var intervalBPM = Math.round(Math.abs(60 / (peak.intervals[j] /
            sampleRate)));
      ...
      peaksAtTopTempo = peaksAtTopTempo.filter(function(peakTime, index,
        arr) {
    ...
    p5.SoundFile.prototype._onTimeUpdate = function(position) {
      ...
      for (var i = 0; i < cueLength; i++) {
        ...
        var val = cue.val;
        if (this._prevTime < callbackTime && callbackTime <=
          playbackTime) {
      ...
      for (var channel = 0; channel < event.inputBuffer.numberOfChannels; channel++) {
        ...
        for (var i = 0; i < bufLength; i++) {
          ...
          if (this.normalize) {
            ...
            sum += Math.max(Math.min(x / this.volMax, 1), -1) * Math.max(
              Math.min(x / this.volMax, 1), -1);
          } else {
            total += x;
            sum += x * x;
          }
        ...
        this.stereoVol[channel] = Math.max(rms, this.stereoVol[channel] *
          this.smoothing);
        this.stereoAvg[channel] = Math.max(average, this.stereoVol[
          channel] * this.smoothing);
        this.volMax = Math.max(this.stereoVol[channel], this.volMax);
      }
      // add volume from all channels together
      var self = this;
      var volSum = this.stereoVol.reduce(function(previousValue,
        currentValue, index) {
        self.stereoVolNorm[index - 1] = Math.max(Math.min(self.stereoVol[
          index - 1] / self.volMax, 1), 0);
        self.stereoVolNorm[index] = Math.max(Math.min(self.stereoVol[
          index] / self.volMax, 1), 0);
  ...
  fft = function() {
    ...
    p5.FFT.prototype.waveform = function() {
      ...
      if (mode && !p5.prototype._isSafari()) {
        ...
        for (var i = 0; i < this.timeDomain.length; i++) {
          var scaled = p5.prototype.map(this.timeDomain[i], 0, 255, -1,
            1);
    ...
    p5.FFT.prototype.getEnergy = function(frequency1, frequency2) {
      ...
      if (typeof frequency1 !== 'number') {
        ...
        var lowIndex = Math.round(frequency1 / nyquist * this.freqDomain
          .length);
        var highIndex = Math.round(frequency2 / nyquist * this.freqDomain
          .length);
        var total = 0;
    ...
    p5.FFT.prototype.getCentroid = function() {
      ...
      var spec_centroid_freq = mean_freq_index * (nyquist / this.freqDomain
        .length);
  ...
  Tone_core_Tone = function() {
    ...
    if (!isFunction(AudioBufferSourceNode.prototype.start)) {
      AudioBufferSourceNode.prototype.start = AudioBufferSourceNode.prototype
        .noteGrainOn;
    }
    if (!isFunction(AudioBufferSourceNode.prototype.stop)) {
      AudioBufferSourceNode.prototype.stop = AudioBufferSourceNode.prototype
        .noteOff;
    }
    ...
    if (!isFunction(OscillatorNode.prototype.setPeriodicWave)) {
      OscillatorNode.prototype.setPeriodicWave = OscillatorNode.prototype
        .setWaveTable;
    }
    ...
    Tone.prototype.set = function(params, value, rampTime) {
      ...
      for (var attr in params) {
        ...
        if (Tone.Signal && param instanceof Tone.Signal || Tone.Param &&
          param instanceof Tone.Param) {
    ...
    Tone.prototype.defaultArg = function(given, fallback) {
      if (this.isObject(given) && this.isObject(fallback)) {
        ...
        for (var givenProp in given) {
          ret[givenProp] = this.defaultArg(fallback[givenProp], given[
            givenProp]);
        }
        for (var fallbackProp in fallback) {
          ret[fallbackProp] = this.defaultArg(given[fallbackProp],
  ...
  Tone_signal_SignalBase = function(Tone) {
    ...
    Tone.SignalBase.prototype.connect = function(node, outputNumber,
      inputNumber) {
      if (Tone.Signal && Tone.Signal === node.constructor || Tone.Param &&
        Tone.Param === node.constructor || Tone.TimelineSignal && Tone.TimelineSignal ===
        node.constructor) {
  ...
  Tone_core_Type = function(Tone) {
    ...
    Tone.prototype.notationToSeconds = function(notation, bpm,
      timeSignature) {
      bpm = this.defaultArg(bpm, getTransportBpm());
      timeSignature = this.defaultArg(timeSignature,
    ...
    Tone.prototype.secondsToTransportTime = function(seconds, bpm,
      timeSignature) {
      bpm = this.defaultArg(bpm, getTransportBpm());
      timeSignature = this.defaultArg(timeSignature,
        getTransportTimeSignature());
        ...
        if (time.indexOf('@') !== -1) {
          ...
          if (components.length > 1) {
            ...
            try {
              ...
              throw new EvalError('cannot evaluate Time: ' +
                originalTime);
            }
    ...
    Tone.prototype.toNotation = function(time, bpm, timeSignature) {
      ...
      var retNotation = toNotationHelper.call(this, time, bpm,
        timeSignature, testNotations);
      ...
      var retTripletNotation = toNotationHelper.call(this, time, bpm,
        timeSignature, testTripletNotations);
      if (retTripletNotation.split('+').length < retNotation.split('+')
        .length) {
    ...
    function toNotationHelper(time, bpm, timeSignature, testNotations) {
      var seconds = this.toSeconds(time);
      var threshold = this.notationToSeconds(testNotations[testNotations.length -
        1], bpm, timeSignature);
      var retNotation = '';
      for (var i = 0; i < testNotations.length; i++) {
        var notationTime = this.notationToSeconds(testNotations[i], bpm,
          timeSignature);
  ...
  Tone_core_Param = function(Tone) {
    ...
    Tone.Param.prototype.linearRampToValueAtTime = function(value,
      endTime) {
      value = this._fromUnits(value);
      this._param.linearRampToValueAtTime(value, this.toSeconds(endTime));
      return this;
    };
    Tone.Param.prototype.exponentialRampToValueAtTime = function(value,
      endTime) {
      value = this._fromUnits(value);
      value = Math.max(this._minOutput, value);
      this._param.exponentialRampToValueAtTime(value, this.toSeconds(
        endTime));
      return this;
    };
    Tone.Param.prototype.exponentialRampToValue = function(value,
      rampTime) {
      var now = this.now();
      var currentVal = this.value;
      this.setValueAtTime(Math.max(currentVal, this._minOutput), now);
      this.exponentialRampToValueAtTime(value, now + this.toSeconds(
        rampTime));
      return this;
    };
    ...
    Tone.Param.prototype.setTargetAtTime = function(value, startTime,
      timeConstant) {
      value = this._fromUnits(value);
      value = Math.max(this._minOutput, value);
      timeConstant = Math.max(this._minOutput, timeConstant);
      this._param.setTargetAtTime(value, this.toSeconds(startTime),
        timeConstant);
      return this;
    };
    Tone.Param.prototype.setValueCurveAtTime = function(values, startTime,
      duration) {
      for (var i = 0; i < values.length; i++) {
        values[i] = this._fromUnits(values[i]);
      }
      this._param.setValueCurveAtTime(values, this.toSeconds(startTime),
    ...
    Tone.Param.prototype.rampTo = function(value, rampTime) {
      ...
      if (this.units === Tone.Type.Frequency || this.units === Tone.Type
        .BPM) {
  ...
  Tone_signal_Signal = function(Tone) {
    ...
    return Tone.Signal;
  }(Tone_core_Tone, Tone_signal_WaveShaper, Tone_core_Type,
    Tone_core_Param);
  /** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
  var Tone_signal_Add;
  Tone_signal_Add = function(Tone) {
    ...
    Tone.Add = function(value) {
      Tone.call(this, 2, 0);
      this._sum = this.input[0] = this.input[1] = this.output = this.context
        .createGain();
  ...
  }(Tone_signal_Signal, Tone_signal_Add, Tone_signal_Multiply,
    Tone_signal_Scale, Tone_core_Tone, master);
  var oscillator;
  oscillator = function() {
    'use strict';
    var p5sound = master;
    ...
    p5.Oscillator = function(freq, type) {
      ...
      this.f = freq || 440;
      // frequency
      this.oscillator.frequency.setValueAtTime(this.f, p5sound.audiocontext
        .currentTime);
    ...
    p5.Oscillator.prototype.start = function(time, f) {
      ...
      if (!this.started) {
        ...
        this.oscillator = p5sound.audiocontext.createOscillator();
        this.oscillator.frequency.exponentialRampToValueAtTime(Math.abs(
          freq), p5sound.audiocontext.currentTime);
    ...
    p5.Oscillator.prototype.freq = function(val, rampTime, tFromNow) {
      if (typeof val === 'number' && !isNaN(val)) {
        ...
        if (rampTime == 0) {
          ...
          if (val > 0) {
            this.oscillator.frequency.exponentialRampToValueAtTime(val,
              tFromNow + rampTime + now);
          } else {
            this.oscillator.frequency.linearRampToValueAtTime(val,
              tFromNow + rampTime + now);
          }
        }
  ...
  }(master, Tone_signal_Signal, Tone_signal_Add, Tone_signal_Multiply,
    Tone_signal_Scale);
  /** Tone.js module by Yotam Mann, MIT License 2016  http://opensource.org/licenses/MIT **/
  ...
  Tone_core_Timeline = function(Tone) {
    ...
    Tone.Timeline = function() {
      var options = this.optionsObject(arguments, ['memory'], Tone.Timeline
        .defaults);
      this._timeline = [];
      this._toRemove = [];
    ...
    Tone.Timeline.prototype._iterate = function(callback, lowerBound,
      upperBound) {
      this._iterating = true;
      lowerBound = this.defaultArg(lowerBound, 0);
      upperBound = this.defaultArg(upperBound, this._timeline.length -
        1);
  ...
  Tone_signal_TimelineSignal = function(Tone) {
    ...
    Tone.TimelineSignal.prototype.setValueAtTime = function(value,
      startTime) {
      value = this._fromUnits(value);
    ...
    Tone.TimelineSignal.prototype.setTargetAtTime = function(value,
      startTime, timeConstant) {
      value = this._fromUnits(value);
      value = Math.max(this._minOutput, value);
      timeConstant = Math.max(this._minOutput, timeConstant);
      startTime = this.toSeconds(startTime);
    ...
    Tone.TimelineSignal.prototype.getValueAtTime = function(time) {
      ...
      if (before === null) {
        ...
        value = this._exponentialApproach(before.time, previouVal,
          before.value, before.constant, time);
      } else if (after === null) {
        value = before.value;
      } else if (after.type === Tone.TimelineSignal.Type.Linear) {
        value = this._linearInterpolate(before.time, before.value,
          after.time, after.value, time);
      } else if (after.type === Tone.TimelineSignal.Type.Exponential) {
        value = this._exponentialInterpolate(before.time, before.value,
          after.time, after.value, time);
      } else {
        value = before.value;
      }
    ...
    Tone.TimelineSignal.prototype._exponentialApproach = function(t0, v0,
      v1, timeConstant, t) {
      return v1 + (v0 - v1) * Math.exp(-(t - t0) / timeConstant);
    };
    Tone.TimelineSignal.prototype._linearInterpolate = function(t0, v0,
      t1, v1, t) {
      return v0 + (v1 - v0) * ((t - t0) / (t1 - t0));
    };
    Tone.TimelineSignal.prototype._exponentialInterpolate = function(t0,
      v0, t1, v1, t) {
  ...
  env = function() {
    ...
    p5.Env.prototype.setRampPercentages = function(p1, p2) {
      ...
      /// Aatish Bhatia's calculation for time constant for rise(to adjust 1/1-e calculation to any percentage)
      TCDenominator = Math.log(1 / this.checkExpInput(1 - this._rampHighPercentage));
      this._rampAttackTC = this._rampAttackTime / this.checkExpInput(
        TCDenominator);
      TCDenominator = Math.log(1 / this._rampLowPercentage);
      this._rampDecayTC = this._rampDecayTime / this.checkExpInput(
        TCDenominator);
    };
    /**
    ...
    p5.Env.prototype.play = function(unit, secondsFromNow, susTime) {
      ...
      this.triggerRelease(unit, tFromNow + this.aTime + this.dTime +
        susTime);
    };
    /**
    ...
    p5.Env.prototype.triggerAttack = function(unit, secondsFromNow) {
      ...
      if (this.isExponential == true) {
        this.control.exponentialRampToValueAtTime(this.checkExpInput(
          valToSet), t);
      } else {
    ...
    p5.Env.prototype.ramp = function(unit, secondsFromNow, v1, v2) {
      ...
      var destination2 = typeof v2 !== 'undefined' ? this.checkExpInput(
        v2) : undefined;
    ...
    p5.Env.prototype.connect = function(unit) {
      ...
      if (unit instanceof p5.Oscillator || unit instanceof p5.SoundFile ||
        unit instanceof p5.AudioIn || unit instanceof p5.Reverb || unit instanceof p5
        .Noise || unit instanceof p5.Filter || unit instanceof p5.Delay
      ) {
    ...
    p5.Env.prototype.add = function(num) {
      ...
      var nextChain = this.output;
      return p5.prototype._mathChain(this, add, thisChain, nextChain,
        Add);
    };
    /**
    ...
    p5.Env.prototype.mult = function(num) {
      ...
      var thisChain = this.mathOps.length;
      var nextChain = this.output;
      return p5.prototype._mathChain(this, mult, thisChain, nextChain,
        Mult);
    };
    /**
    ...
    p5.Env.prototype.scale = function(inMin, inMax, outMin, outMax) {
      ...
      var thisChain = this.mathOps.length;
      var nextChain = this.output;
      return p5.prototype._mathChain(this, scale, thisChain, nextChain,
        Scale);
    };
    // get rid of the oscillator
    ...
    Tone_signal_TimelineSignal, Tone_core_Tone);
  var pulse;
  pulse = function() {
    'use strict';
    var p5sound = master;
    ...
    p5.Pulse.prototype.start = function(f, time) {
      ...
      if (!this.started) {
        ...
        if (this.mods !== undefined && this.mods.frequency !==
          undefined) {
    ...
    p5.Pulse.prototype.freq = function(val, rampTime, tFromNow) {
      if (typeof val === 'number') {
        ...
        this.osc2.oscillator.frequency.setValueAtTime(currentFreq, now +
          tFromNow);
        this.osc2.oscillator.frequency.exponentialRampToValueAtTime(val,
          tFromNow + rampTime + now);
        if (this.freqMod) {
  ...
  noise = function() {
    ...
    var _whiteNoise = function() {
      ...
      var whiteBuffer = p5sound.audiocontext.createBuffer(1, bufferSize,
    ...
    var _pinkNoise = function() {
      var bufferSize = 2 * p5sound.audiocontext.sampleRate;
      var pinkBuffer = p5sound.audiocontext.createBuffer(1, bufferSize,
        p5sound.audiocontext.sampleRate);
      ...
      for (var i = 0; i < bufferSize; i++) {
        ...
        noiseData[i] = b0 + b1 + b2 + b3 + b4 + b5 + b6 + white *
          0.5362;
        noiseData[i] *= 0.11;
    ...
    var _brownNoise = function() {
      var bufferSize = 2 * p5sound.audiocontext.sampleRate;
      var brownBuffer = p5sound.audiocontext.createBuffer(1, bufferSize,
        p5sound.audiocontext.sampleRate);
  ...
  audioin = function() {
    ...
    p5.AudioIn = function() {
      ...
      } else if (typeof window.MediaStreamTrack.getSources ===
        'function') {
    ...
    p5.AudioIn.prototype.start = function(successCallback, errorCallback) {
      ...
      if (p5sound.inputSources[self.currentSource]) {
        ...
        window.navigator.getUserMedia(constraints, this._onStream =
          function(stream) {
            self.stream = stream;
            self.enabled = true;
    ...
    p5.AudioIn.prototype.amp = function(vol, t) {
      if (t) {
        ...
        this.output.gain.setValueAtTime(currentVol, p5sound.audiocontext
          .currentTime);
        this.output.gain.linearRampToValueAtTime(vol, rampTime +
    ...
    p5.AudioIn.prototype.listSources = function() {
      console.log(
        'listSources is deprecated - please use AudioIn.getSources');
    ...
    p5.AudioIn.prototype.setSource = function(num) {
      ...
      var self = this;
      if (p5sound.inputSources.length > 0 && num < p5sound.inputSources
        .length) {
        // set the current source
        self.currentSource = num;
        console.log('set source to ' + p5sound.inputSources[self.currentSource]
          .id);
      } else {
  ...
  filter = function() {
    ...
    p5.Filter.prototype.freq = function(freq, time) {
      ...
      if (typeof freq === 'number') {
        ...
        self.biquad.frequency.cancelScheduledValues(this.ac.currentTime +
          0.01 + t);
        self.biquad.frequency.exponentialRampToValueAtTime(freq, this.ac
          .currentTime + 0.02 + t);
      } else if (freq) {
    ...
    p5.Filter.prototype.res = function(res, time) {
      ...
      if (typeof res == 'number') {
        ...
        self.biquad.Q.cancelScheduledValues(self.ac.currentTime + 0.01 +
          t);
        self.biquad.Q.linearRampToValueAtTime(res, self.ac.currentTime +
          0.02 + t);
      } else if (res) {
  ...
  delay = function() {
     ...
     *                               delay.
     */
    p5.Delay.prototype.process = function(src, _delayTime, _feedback,
      _filter) {
      ...
      if (delayTime >= this._maxDelay) {
        throw new Error('Delay Time exceeds maximum delay time of ' +
          this._maxDelay + ' second.');
      }
      src.connect(this.input);
  ...
  reverb = function() {
     ...
     */
    p5.Reverb.prototype.process = function(src, seconds, decayRate,
      reverse) {
      src.connect(this.input);
      var rebuild = false;
      if (seconds) {
    ...
    p5.Reverb.prototype._buildImpulse = function() {
      ...
      for (i = 0; i < length; i++) {
        ...
        impulseL[i] = (Math.random() * 2 - 1) * Math.pow(1 - n / length,
          decay);
        impulseR[i] = (Math.random() * 2 - 1) * Math.pow(1 - n / length,
          decay);
      }
    ...
    p5.Convolver.prototype._loadBuffer = function(path, callback,
      ...
      request.onload = function() {
        if (request.status == 200) {
          ...
          ac.decodeAudioData(request.response, function(buff) {
            ...
            function(e) {
              var err = new CustomError('decodeAudioData',
                errorTrace, self.url);
              var msg =
                'AudioContext error at decodeAudioData for ' + self
                .url;
              if (errorCallback) {
                err.msg = msg;
                errorCallback(err);
          ...
          var err = new CustomError('loadConvolver', errorTrace, self
            .url);
          var msg = 'Unable to load ' + self.url +
            '. The request status was: ' + request.status + ' (' +
            request.statusText + ')';
      ...
      request.onerror = function(e) {
        ...
        var msg = 'There was no response from the server at ' + self.url +
  ...
  Tone_core_Clock = function(Tone) {
    ...
    Tone.Clock = function() {
      ...
      this._lastUpdate = 0;
      this._loopID = -1;
      this.frequency = new Tone.TimelineSignal(options.frequency, Tone.Type
        .Frequency);
      this.ticks = 0;
      ...
      if (this._lookAhead === 'auto') {
        if (!this.isUndef(time)) {
          ...
          if (diff < this._threshold) {
            this._computedLookAhead = (9 * this._computedLookAhead +
              diff) / 10;
          }
        }
      } else {
  ...
  metro = function() {
      ...
      if (elapsedTime - tatumTime <= -0.02) {
        ...
        for (var i in this.syncedParts) {
          ...
          for (var j in thisPart.phrases) {
            ...
            if (phraseArray[bNum] !== 0 && (this.metroTicks <
                phraseArray.length || !thisPhrase.looping)) {
    ...
    p5.Metro.prototype.setBPM = function(bpm, rampTime) {
      ...
      tatumTime = beatTime;
      var rampTime = rampTime || 0;
      this.clock.frequency.setValueAtTime(this.clock.frequency.value,
        now);
  ...
  soundRecorder = function() {
    ...
    p5.SoundRecorder = function() {
      ...
      this._jsNode = ac.createScriptProcessor(this.bufferSize, this._channels,
        2);
     ...
     */
    p5.SoundRecorder.prototype.record = function(sFile, duration,
      callback) {
      this.recording = true;
      if (duration) {
  ...
  peakdetect = function() {
    ...
    p5.PeakDetect.prototype.update = function(fftObject) {
      var nrg = this.energy = fftObject.getEnergy(this.f1, this.f2) /
        255;
      if (nrg > this.cutoff && nrg > this.threshold && nrg - this.penergy >
        0) {
        // trigger callback
        this._onPeak();
  ...
  src_app = function() {
    ...
    var p5SOUND = sndcore;
    return p5SOUND;
  }(sndcore, master, helpers, errorHandler, panner, soundfile, amplitude,
    fft, signal, oscillator, env, pulse, noise, audioin, filter, delay,
    reverb, metro, looper, soundRecorder, peakdetect, gain);
}));
